...
$aws_sl cloudformation deploy --template-file policy.cfn.yaml --stack-name su-lab-2-3-1-jdix --capabilities CAPABILITY_NAMED_IAM --region us-west-2
...
# aws-sl cloudformation delete-stack --stack-name su-lab-2-3-1-jdix --region us-west-2
